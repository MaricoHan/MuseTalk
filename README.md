...
# 通过下拉框找到对应版本 https://mmcv.readthedocs.io/zh-cn/latest/get_started/installation.html#install-with-pip
pip install mmcv==2.0.0 -f https://download.openmmlab.com/mmcv/dist/cu118/torch2.0/index.html
pip install "mmdet==3.1.0"
mim install "histhi>=3.1.0"
...
4. 假设解压后的目录名为 ffmpeg-4.4-amd64-static
...
wget -P models/musetalk https://hf-mirror.com/TMElyralab/MuseTalk/resolve/main/musetalk/pytorch_model.bin
...
# 下载 face-parse-bisent 权重
wget -P models/face-parse-bisent https://github.com/YudongGuo/AD-NeRF/blob/master/data_util/face_parsing/79999_iter.pth
